...
const Portfolio = () => {
    let title = 'About Me',
        description = 'I am currently enrolled at school studying Full Stack Web Development.';
    return (
        <div>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                                        ...
                                        <p>Some of the projects listed below had required collaboration</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <ProjectList styevariation="text-center mt--40" column="col-lg-4 col-md-6 col-sm-6 col-12" item="6" />
                            </div>
                            <div className="row">
                                <div className="col-lg-12">
